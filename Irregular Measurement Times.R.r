...
# spline
tobs = c(0.05, 0.12, 0.16, 0.19, 0.23, 0.25, 0.32, 0.38, 0.43, 0.49, 0.51, 0.59, 0.65, 0.71, 0.74, 0.78, 0.83, 0.89, 0.96, 1)
...
ci.true=t(matrix(c(rep(c(1,0),0), rep(c(0,1),12)),ncol=2,byrow = TRUE))
muktl=rep(0,I*ni*T)
...
tobs = tobs = c(0.05, 0.12, 0.16, 0.19, 0.23, 0.25, 0.32, 0.38, 0.43, 0.49, 0.51, 0.59, 0.65, 0.71, 0.74, 0.78, 0.83, 0.89, 0.96, 1)
